...
//    open func requestNotification() {
//        let contentNotification = UNMutableNotificationContent()
//        contentNotification.title = ""
//        contentNotification.body = ""
//        contentNotification.sound = UNNotificationSound.default()
//        
//        let triggerTime = UNTimeIntervalNotificationTrigger(timeInterval: 300, repeats: true)
////        let triggerDate = UNTimeIntervalNotificationTrigger(timeInterval: 300, repeats: true)
//        
//        let date = Date(timeIntervalSinceNow: 3600)
//        let triggerDate = Calendar.current.dateComponents([.year,.month,.day,.hour,.minute,.second,], from: date)
//        let triggerCalendar = UNCalendarNotificationTrigger(dateMatching: triggerDate, repeats: false)
//        
...
//                                            content: contentNotification, trigger: triggerTime)
//        self.notificationCenter.add(request, withCompletionHandler: { (error) in
//            if let error = error {
...
//        
//        self.notificationCenter.setNotificationCategories([category])
//        contentNotification.categoryIdentifier = "UYLReminderCategory"
//
//    }
}
